...
<!-- form for editing vaults -->
        <v-layout row>
        <v-dialog v-model="editDialogVal" persistent max-width="500px">
         
          
          <v-card>
            <v-card-title>
              <span class="headline align-center">Edit Vault</span>
            </v-card-title>
            <!-- <div v-for="keep in keeps" :key="keep._id"> -->
            <v-card-text>
              <v-container grid-list-md>
      ...
      <div class="page-wrapper">
        ...
        <div class="vaults">
          <div v-for="vault in vaults" :key="vault.id">
            ...
            <v-btn @click="keepsPage(vault)">View Vaults </v-btn>

          <v-btn @click="deleteVault(vault.id)" class="mt-5" small fab  color="white" light>
            <v-icon>delete_forever</v-icon>
          </v-btn>

           <v-btn @click="editKeep(vault.id)" class="mt-5" small fab  color="white" light>
            <v-icon>edit</v-icon>
          </v-btn>
